...
/* NB: Remember compiling math.h with gcc requires `-lm` */
...
/**
 * jump_search - A function that searches for a value in a sorted array of integers using
...
int jump_search(int *array, size_t size, int value)
{
	...
	/* causes 'found' msg even if  value not in array */
